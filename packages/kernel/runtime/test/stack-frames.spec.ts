...
const workspaceReforceFrame =
  "    at WebEngine.start (/home/dev/reforce/packages/web/web-node/dist/engine.js:41:9)";
const coreWorkspaceFrame =
  "    at BeanResolver.resolve (/home/dev/reforce/packages/kernel/core/dist/bean-resolver.js:73:15)";
...
describe("foldStackFrames", () => {
  ...
  test("folds a workspace packages/kernel/core/dist frame", () => {
